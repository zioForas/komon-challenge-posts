    ...
    <>
     <div className="w-full mt-5 mb-10">
          <div className="text-black flex justify-center w-full z-10">
            ...
            <button
              className="w-full h-8 md:h-12 focus:ring-4 group flex items-center justify-center p-0.7 text-center font-medium focus:z-10 rounded-lg cursor-pointer bg-transparent text-white border border-solid border-white"
              data-dashlane-rid="d992ed1aec9a10c0"
            >
